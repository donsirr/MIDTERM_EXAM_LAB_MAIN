                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 08/10/2024</p>
                            <p>G0BIOS (C) 2024 GROUP0 CS1A.,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>CS 1A BATCH 2024</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>GRP0 Showcase(tm) XX 113</p>
